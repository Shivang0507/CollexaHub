...
public class AddEventDialogFragment extends DialogFragment {
    ...
    private RadioButton radioIndividual, radioTeam;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        radioGroupEventType = view.findViewById(R.id.radioGroupEventType);
        radioIndividual = view.findViewById(R.id.radioIndividual);
        radioTeam = view.findViewById(R.id.radioTeam);
        ...
        radioGroupEventType.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId == R.id.radioTeam) {
                etTeamSize.setVisibility(View.VISIBLE);
            } else {
                etTeamSize.setVisibility(View.GONE);
                etTeamSize.setText("");
            }
        });
        ...
        if (event != null) {
            ...
            if (event.teamEvent) {
                radioTeam.setChecked(true);
                etTeamSize.setVisibility(View.VISIBLE);
                etTeamSize.setText(String.valueOf(event.maxTeamSize));
            } else {
    ...
    private void saveEvent() {
        ...
        boolean isTeamEvent = radioTeam.isChecked();
        int maxTeamSize = 0;
        ...
        if (isTeamEvent) {
            String sizeStr = etTeamSize.getText().toString().trim();
            if (TextUtils.isEmpty(sizeStr)) {
                etTeamSize.setError("Enter team size");
                return;
            }
            maxTeamSize = Integer.parseInt(sizeStr);
        }
